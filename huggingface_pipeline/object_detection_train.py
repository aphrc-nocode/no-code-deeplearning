...
from object_detection_utils.data_utils import load_detection_dataset, augment_and_transform_batch, filter_invalid_objects_coco
...
def main(args):
    ...
    dataset = dataset.map(filter_invalid_objects_coco, num_proc=args.dataloader_num_workers)
